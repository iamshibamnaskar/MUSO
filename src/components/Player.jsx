...
export const PlayCircleIcon = ({ size = 24, width, height, ...props }) => {
    return (
        ...
        >
            <path
                d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 15V7l6 5-6 5z"
                fill="currentColor"
            />
        </svg>
    );
...
const MusicPlayer = ({ isOpen, onClose, songUrl }) => {
    ...
    //             console.log("Thumbnail:", info.videoDetails.thumbnails.pop().url); // Get the highest resolution thumbnail
    //         } else {
